...
function bp_poke_get_poke_list_url( $user_id = false ){
    ...
    return bp_core_get_user_domain( $user_id ) . bp_get_settings_slug() . '/pokes/';
}
...
function bp_poke_is_poke_action(){
    ...
    if( is_user_logged_in() && bp_is_my_profile() && bp_is_settings_component() && bp_is_current_action( 'pokes' ) )
        return true;
